...
# Generated on: Wed Apr 06 22:34:13 IST 2022 (Wed Apr 06 17:04:13 GMT 2022)
...
set_log_file fv/fifo/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/fifo -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/cad/cadence/digital_ic_design/genus/tools.lnx86"
set CDN_SYNTH_ROOT      "/cad/cadence/digital_ic_design/genus/tools.lnx86"
set env(CW_DIR) "/cad/cadence/digital_ic_design/genus/tools.lnx86/lib/chipware"
set CW_DIR      "/cad/cadence/digital_ic_design/genus/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/synth/libs/ -library -both
read_library -liberty -both /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/synth/libs/uk65lscllmvbbr_100c25_tc_ccs.lib
...
add_search_path /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/ -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/fifo.v /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/fifomem.v /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/rptr_empty.v /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/sync_r2w.v /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/sync_w2r.v /afs/iitd.ac.in/user/j/jv/jvl202215/elp736/assignments/assignment2/rtl/wptr_full.v
...
#add_name_alias fv/fifo/fv_map.singlebit.original_name.alias.json.gz -revised
...
if {$lec_version >= $lec_version_required} {
    analyze_results -logfiles fv/fifo/rtl_to_fv_map.log
}
